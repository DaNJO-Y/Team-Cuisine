...
searchForm.addEventListener('submit',(e)=>{
  e.preventDefault();
  searchQuery=e.target.querySelector('[name="Countries"]').value;
  console.log(searchQuery)
  showAllData();
})

async function getData(){
  const base=`https://api.edamam.com/api/recipes/v2?type=public&app_id=${API_ID}&app_key=${API_KEY}&cuisineType=${searchQuery}&random=true&to=100`;
